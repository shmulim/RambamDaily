var com = {} || com;
com.RambamDaily = {};
com.RambamDaily.HebrewDate = (function() {
    ...
    function displayWeekday() {
        getToday();
        return gWeekday[today.getDay()] + "day";
    }
    ...
    var weekday = displayWeekday();
    SdnToHebrew(GregorianToSdn(today.getFullYear(), today.getMonth() + 1, today.getDate()));
    var dayMonthYr = displayHebrewDate();

    return {
        dayMonthYr: dayMonthYr,
        weekday: weekday
    };
})();

console.log(com.RambamDaily.HebrewDate.weekday); // Wednesday
console.log(com.RambamDaily.HebrewDate.dayMonthYr); // 24 Iyyar 5775